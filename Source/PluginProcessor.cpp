...
//==============================================================================
const juce::String PlugIn2AudioProcessor::getName() const
{
...
bool PlugIn2AudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
const juce::String PlugIn2AudioProcessor::getProgramName (int index)
{
    return {};
}

void PlugIn2AudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void PlugIn2AudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool PlugIn2AudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void PlugIn2AudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* PlugIn2AudioProcessor::createEditor()
{
    return new PlugIn2AudioProcessorEditor(*this);
}

//==============================================================================
void PlugIn2AudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
